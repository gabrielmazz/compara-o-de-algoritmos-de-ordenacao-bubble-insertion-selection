...
int main() {
    ...
    FILE* result = fopen("resultadosSelection.txt", "w");
    double start, end;
    ...
    for (int i = 0; i < numIndices; i++) {
        ...
        clock_t start = clock();
        selectionSort(ol, olSize);
        clock_t end = clock();
        double time_taken = ((double)(end - start)) / CLOCKS_PER_SEC;
        printf("Tempo de Selection Sort para Ordenado com %d itens: %f\n", indices[i], time_taken);
        fprintf(result, "Tempo de Selection Sort para Ordenado com %d itens: %f\n", indices[i], time_taken);
        
        start = clock();
        selectionSort(dl, dlSize);
        end = clock();
        time_taken = ((double)(end - start)) / CLOCKS_PER_SEC;
        printf("Tempo de Selection Sort para Decrescente com %d itens: %f\n", indices[i], time_taken);
        fprintf(result, "\nTempo de Selection Sort para Decrescente com %d itens: %f\n", indices[i], time_taken);
        
        start = clock();
        selectionSort(pl, plSize);
        end = clock();
        time_taken = ((double)(end - start)) / CLOCKS_PER_SEC;
        printf("Tempo de Selection Sort para Parcialmente Ordenado com %d itens: %f\n", indices[i], time_taken);
        fprintf(result, "\nTempo de Selection Sort para Parcialmente Ordenado com %d itens: %f\n", indices[i], time_taken);
        
        start = clock();
        selectionSort(al, alSize);
        end = clock();
        time_taken = ((double)(end - start)) / CLOCKS_PER_SEC;
        printf("Tempo de Selection Sort para Aleatório com %d itens: %f\n", indices[i], time_taken);
        fprintf(result, "\nTempo de Selection Sort para Aleatorio com %d itens: %f\n", indices[i], time_taken);
